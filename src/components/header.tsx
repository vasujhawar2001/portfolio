...
export default function Header() {
  ...
  return (
    <header className="relative">
      <motion.div
        className="fixed top-2 left-1/2 h-16 w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg 
      ...
      >
        ...
        <ul className="flex items-center justify-evenly text-base font-medium text-gray-500 sm:gap-5">
          {links.map((link) => (
            <motion.li
